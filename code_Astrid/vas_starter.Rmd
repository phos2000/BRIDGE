...
## Source Data
BRIDGE follow-up datasets for all sites.  
Data in this version was pulled on 8/8/2022 using REDCapDB.Rmd and BRIDGE_DatIn_rename.R.  
I try to redo every step in Zilu's markdown and compare mine to hers. 
...
## Check N
For EUC(enhanced usual care): Mine is 893, Zilu's is 890  
For TSC(intervention arm): Mine is 899, Zilu's is 888  

A good news is that the numbers of unique participants with any follow-up care form records increased(from 98.3% to 99.1%, from 96.2% to 97.3%).  
...
Only the NA part increases extremely(from 9097 to 14131).  
The variable, missed_fu(Question: If this follow-up was missed, why was it missed?) is not mandatory so many responses are just left blank. 
