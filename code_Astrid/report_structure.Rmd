...
save(fu, bs, allq, fcf_c, gender, fudw, gender, location, dob, file = "with-drop-out.rda")
```
...
save(fu, bs, allq, fcf, fcf_c, gender, fudw, gender, location, dob, file = "without-drop-out.rda")
```
# Results
