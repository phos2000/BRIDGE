...
pct_severe = seizure_times %>% mutate(severity = ifelse(seiz_freq >= 1, "severe epilepsy", "seizure-free, treated epilepsy")) %>%
...
If compare them **annually per 1000 individuals,** incremental effectiveness using DALY weight for each year for the same population size = **(0.03 \* 0.552 + 0.97 \* 0.049) - (0.10 \* 0.552 + 0.90 \* 0.049) = `r (0.03 * 0.552 + 0.97 * 0.049) - (0.1 * 0.552 + 0.90 * 0.049)`**
